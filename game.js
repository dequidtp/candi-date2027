...
const CANDIDATES = [
  ...
  { name: "Nicolas Dupont-Aignan",    desc: "Souverainiste",                                         cat: "Debout la France",    color: "#1a4fa0",
  ...
  { name: "Sarah Knafo",              desc: "Députée européenne, ex-conseillère de Zemmour",         cat: "Reconquête",          color: "#a00000",
  ...
  { name: "Robert Ménard",            desc: "Maire de Béziers, polémiste",                           cat: "Électron libre",      color: "#7f1d1d",
  ...
  { name: "Dominique de Villepin",    desc: "Ancien Premier ministre, diplomate",                    cat: "La France Humaniste", color: "#2c3e6b",
  ...
  { name: "François Molins",          desc: "Ancien procureur de Paris",                             cat: "Électron libre",      color: "#455a64",
  ...
  { name: "François Ruffin",          desc: "Réalisateur, ancien député LFI",                        cat: "Debout !",            color: "#b71c1c",
  ...
  { name: "Clémentine Autain",        desc: "Ancienne députée LFI",                                  cat: "L'Après",             color: "#7b1fa2",
  ...
  { name: "Sandrine Rousseau",        desc: "Députée écoféministe",                                  cat: "Les Écologistes",     color: "#388e3c",
  ...
  { name: "Nathalie Arthaud",         desc: "Professeure, candidate LO",                             cat: "Lutte Ouvrière",      color: "#8B0000",
  ...
  { name: "Cyril Hanouna",            desc: "Animateur TV, provocateur",                             cat: "Électron libre",      color: "#ff6600",
  ...
  { name: "Patrick Sébastien",        desc: "Animateur, icône populaire",                            cat: "Électron libre",      color: "#e65100",
  ...
  { name: "Stéphane Bern",            desc: "Journaliste, défenseur du patrimoine",                  cat: "Électron libre",      color: "#8d6e63",
  ...
  { name: "Vincent Lindon",           desc: "Acteur César, militant",                                cat: "Électron libre",      color: "#37474f",
  ...
  { name: "Omar Sy",                  desc: "Acteur international, icône",                           cat: "Électron libre",      color: "#4e342e",
    photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/Omar_Sy_%28cropped%29.jpg/240px-Omar_Sy_%28cropped%29.jpg" },
  { name: "Jamel Debbouze",           desc: "Humoriste, entrepreneur",                               cat: "Électron libre",      color: "#bf360c",
    photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a3/Jamel_Debbouze_%28cropped%29.jpg/240px-Jamel_Debbouze_%28cropped%29.jpg" },
  { name: "Dany Boon",                desc: "Acteur, réalisateur Ch'ti",                             cat: "Électron libre",      color: "#5d4037",
    photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b8/Dany_Boon_%28cropped%29.jpg/240px-Dany_Boon_%28cropped%29.jpg" },
  { name: "Florence Foresti",         desc: "Reine du stand-up",                                     cat: "Électron libre",      color: "#4a148c",
  ...
  // ⚽ Sport
  { name: "Zinédine Zidane",          desc: "Légende du football mondial",                           cat: "Électron libre",      color: "#1565c0",
  ...
  { name: "Teddy Riner",              desc: "13x Champion du monde de judo",                         cat: "Électron libre",      color: "#283593",
  ...
  { name: "Xavier Niel",              desc: "Fondateur de Free, milliardaire tech",                  cat: "Électron libre",      color: "#455a64",
  ...
  { name: "Bernard Arnault",          desc: "PDG de LVMH, homme le plus riche du monde",             cat: "Électron libre",      color: "#3e2723",
  ...
  { name: "Michel-Édouard Leclerc",   desc: "Président des centres E.Leclerc",                      cat: "Électron libre",      color: "#e53935",
  ...
  { name: "Nicolas Hulot",            desc: "Écologiste, ancien ministre",                           cat: "Électron libre",      color: "#2e7d32",
    photo: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5a/Nicolas_Hulot_%28cropped%29.jpg/240px-Nicolas_Hulot_%28cropped%29.jpg" },
  { name: "Rokhaya Diallo",           desc: "Journaliste, militante antiraciste",                    cat: "Électron libre",      color: "#6a1b9a",
  ...
  { name: "Jean-Marc Jancovici",      desc: "Expert énergie et climat",                             cat: "Électron libre",      color: "#1b5e20",
  ...
  { name: "Thomas Piketty",           desc: "Économiste, spécialiste des inégalités",               cat: "Électron libre",      color: "#00695c",
  ...
  { name: "Gabriel Zucman",           desc: "Économiste, spécialiste de l'évasion fiscale",         cat: "Électron libre",      color: "#00796b",
  ...
  { name: "Aurélien Barrau",          desc: "Astrophysicien, militant écologiste",                  cat: "Électron libre",      color: "#1a237e",
  ...
  { name: "Raphaël Enthoven",         desc: "Philosophe, chroniqueur",                              cat: "Électron libre",      color: "#4527a0",
